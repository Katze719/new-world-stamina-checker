...
video_path = "2025-02-03 17-10-18.mp4"
...
while True:
    ...
    roi_x1, roi_x2 = int(width * 0.403), int(width * 0.555)  # Mittig
    roi_y1, roi_y2 = int(height * 0.71), int(height * 0.93)  # Unten
    roi = frame[roi_y1:roi_y2, roi_x1:roi_x2]

    # Bild in Graustufen konvertieren und verarbeiten
    gray = cv2.cvtColor(roi, cv2.COLOR_BGR2GRAY)
    # gray = cv2.GaussianBlur(gray, (3, 3), 0)
    gray = cv2.threshold(gray, 180, 255, cv2.THRESH_TOZERO)[1]
